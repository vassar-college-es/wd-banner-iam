create or replace PROCEDURE       WD_CREATE_SPRIDEN (
...
BEGIN
   ...
   begin
   insert into spriden (spriden_pidm, SPRIDEN_ID, SPRIDEN_LAST_NAME, SPRIDEN_FIRST_NAME, SPRIDEN_ENTITY_IND, SPRIDEN_ACTIVITY_DATE, SPRIDEN_DATA_ORIGIN)
   values (p7, p6, p3, p2, 'P', p8, 'WORKDAY');
