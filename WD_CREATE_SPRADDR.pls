create or replace PROCEDURE       WD_CREATE_SPRADDR (
...
BEGIN
  ...
  begin
   insert into spraddr (spraddr_pidm, spraddr_atyp_code, spraddr_seqno, spraddr_from_date, spraddr_street_line1, spraddr_street_line2, spraddr_street_line3,  
   spraddr_city, spraddr_stat_code, spraddr_zip, SPRADDR_ACTIVITY_DATE, SPRADDR_USER)
   values (p7, 'AC', 1, to_date(p28,'YYYY-MM-DD'), p40, 'Vassar College', null, 'Poughkeepsie', 'NY', '12604', sysdate, 'WORKDAY'
   );
   ...
   if return_code != '401' then
      ...
      from stvbldg
      where trim(stvbldg_desc) = trim(p17);
      ...
      insert into spraddr (spraddr_pidm, spraddr_atyp_code, spraddr_seqno, spraddr_from_date, spraddr_street_line1, spraddr_street_line2, spraddr_street_line3,  
      spraddr_city, spraddr_stat_code, spraddr_zip, SPRADDR_ACTIVITY_DATE, SPRADDR_USER)
      values (p7, 'SC', 1, to_date(p28,'YYYY-MM-DD'), banner_bldg_code, null, null, 'Poughkeepsie', 'NY', '12604', sysdate, 'WORKDAY'
      );
      exception when OTHERS then
          return_code := 401;
          return_status := SUBSTR(SQLERRM, 1, 100);
