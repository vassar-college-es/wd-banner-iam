create or replace PROCEDURE       WD_CREATE_GOREMAL (
...
if p22 is not null then
   begin
   insert into goremal (goremal_pidm, goremal_emal_code, goremal_email_address, goremal_status_ind, GOREMAL_USER_ID, GOREMAL_DISP_WEB_IND, GOREMAL_PREFERRED_IND, GOREMAL_ACTIVITY_DATE)
   values (p7, 'PERS', p22, 'A', 'WORKDAY', 'N', 'Y', sysdate);
